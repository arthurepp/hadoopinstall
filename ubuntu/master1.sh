...
sudo tar -xzvf /install/hadoop-3.2.1.tar.gz -C /usr/local/hadoop --strip-components=1
...
sudo tar -xzvf /install/spark-2.4.7-bin-hadoop2.7.tgz -C /usr/local/hadoop/spark --strip-components=1
sudo tar -xzvf /install/mysql-connector-java-5.1.47.tar.gz -C /install/
sudo tar -xzvf /install/zeppelin-0.8.2-bin-all.tgz -C /usr/local/hadoop/zeppelin --strip-components=1
