...
sudo apt-get update && sudo apt-get -y upgrade && sudo apt-get -y dist-upgrade && sudo apt-get install -y mysql-server && sudo apt-get -y install openjdk-8-jdk-headless && sudo apt-get -y install openssh-server
